...
🚀 PowerPulse API — Manual Testing & Quality Assurance Documentation This repository contains complete documentation, test scenarios, defect logs, and reporting outputs created during the manual testing phase of the PowerPulse API. The goal of this project is to ensure the stability, functionality, and performance of the API through structured QA practices.
...
🎥 Presentation Link
▶️ PowerPulse Manual Project – Presentation Video
